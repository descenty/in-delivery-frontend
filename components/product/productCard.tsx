  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[0.3em] px-[1.5em]">
        ...
        <div className="text-[13px] text-gray-500">{product.description}</div>
        {/* <div className="absolute left-[24px] bottom-[8px] mt-[4px] mb-[10px] flex w-[200px] flex-col">
          <span className="w-full text-[13px] font-semibold">{product.configurationTitle}</span>
          <span className="mt-[-2px] text-[18px] font-bold tracking-[-1px]">от {product.price}&nbsp;₽</span>
        </div> */}
      </div>
    </div>
  );
